var tossupArr = [];
$.getJSON("https://mrbossosity.github.io/quizbowl-collections/clean-acf-regionals-2006-2019.json", function(data) {
  tossupArr = [...data, ...tossupArr];
});

$.getJSON("https://mrbossosity.github.io/quizbowl-collections/clean-acf-fall-2008-2019.json", function(data) {
